...
abstract class TimRestInterface
{
    ...
    /**
     * @param array $to_account 需要查询这些Identifier的在线状态， 一次最多查询500个Identifier的状态,php构造示例:
	 *
	 * 	$to_account = array(
	 *  	'To_Account' => array('id1','id2','id3'),
	 * 	);
	 *
     * @return array 通过解析REST接口json返回包得到的关联数组, 其中包含成功与否、及错误提示(如果有错误)等字段
     */
	abstract function openim_querystate($to_account);
     ...
     */
    abstract function open_msg_svc_get_history($chat_type, $msg_time);
