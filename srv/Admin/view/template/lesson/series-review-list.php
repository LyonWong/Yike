...
<div class="portlet box blue">
    ...
    <div class="portlet-body portlet-compact">
        <div class="datatable-hide-search">
            <table id="series-create-review" class="table table-bordered table-hover">
                <thead>
                <tr>
                    <td>工单Id</td>
                    <td>系列课SN</td>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#series-create-review').DataTable({
                paging: true,
                info: true,
                lengthMenu: [20],
                ordering: false,
                "processing": true,
                "serverSide": true,
                "ajax": '/lesson/series-reviewData?<?=$this->query->toString()?>'
            });
