...
<div class="content">
    ...
    <div class="button" style="padding-top: 20px">
        <?php if($this->recent['event'] && $this->recent['event']=='browse'){
             echo '<button id="button" style="background: #999999">报名后才能参与推广</button>';
        }else {
             echo '<button id="button" onclick="create()">点击创建优惠券</button>';
            if($this->lesson['sn'] == 'L59a66f25d4ade'){echo '<button id="button-2" onclick="create(true)" style="margin-top: 20px">生成优惠券图片</button>';}
        }
        ?>
    </div>
</div>
