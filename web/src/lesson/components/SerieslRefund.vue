<template>
  <popup class="c-lesson-detail-refund flex-col" :isOpen="refund" v-on:close="$emit('cancel')">
      <div slot="head" class="order-head flex-row font-medium">无条件退款</div>
      <div class="order-body">
        <div class="title">待退款课程</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      confirm() {
        this.api.post('/api/order-refund-series', {
