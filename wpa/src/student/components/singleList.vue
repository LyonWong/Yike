    ...
    <ul class="lesson">
      <li v-for="list in lists">
        <a href="javascript:;" class="item" @click="enterDetail(list.sn)">
          <div class="list-img">
            <img v-if="list.cover" :src="`${list.cover}!cover`" />
            <img v-if="!list.cover" :src="`${assetsHost}/static/student/_static/student/img/default.png`" />
          </div>
          <div class="list-content">
            <div class="list-title" v-text="list.title"></div>
            <div class="list-status clearfix">
              <span class="l-gray">{{list.plan.dtm_start}}</span>
            </div>
            <div class="appointment clearfix">
              <span><i class="iconfont icon-xueyuan1"></i> {{ list | specKey('participants') }}&nbsp;&nbsp;</span>
              <span><i class="iconfont icon-jiage1"></i> {{ list | specKey('price') }}</span>
              <div class="list-status new-status">
                ...
                <span class="l-gray" v-if="list.step == 'finish'">可回放</span>
